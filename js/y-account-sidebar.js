fetch("../../components/y-c-account-sidebar.html")
    ...
    if (sidebar && contentContainer) {
      ...
      sidebarLinks.forEach(link => {
        link.addEventListener('click', (e) => {
          ...
          switch (title) {
            case 'تفاصيل الحساب':
              componentPath = '../../components/y-c-account-details.html';
              break;
            case 'الطلبات':
              componentPath = '../../components/y-c-orders.html';
              break;
            case 'العنوان':
              componentPath = '../../components/y-c-address.html';
              break;
            default:
              componentPath = '../../components/y-c-account-details.html';
          }
